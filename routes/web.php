...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::get('/pessoas/{id}/editar', [PessoaController::class, 'edit'])->name('pessoas.editar');
    Route::put('/pessoas/{id}/update', [PessoaController::class, 'update'])->name('pessoas.update');
    Route::delete('/pessoas/{id}/delete', [PessoaController::class, 'destroy'])->name('pessoas.delete');
